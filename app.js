...
const editTask = (li, task) => {
    ...
    editBtn.className = "bg-yellow-500 p-2 ml-2 text-white rounded";
    ...
    if (newTask !== null && newTask.trim() !== "") {
        ...
        completeBtn.className ="ml-2 px-2 py-2 bg-green-500 text-white rounded";
...
const addTask=()=>{
    ...
    const completeBtn = document.createElement("button");
    completeBtn.textContent = "Mark done";
    completeBtn.className ="ml-2 px-2 py-1 bg-green-500 text-white rounded";
